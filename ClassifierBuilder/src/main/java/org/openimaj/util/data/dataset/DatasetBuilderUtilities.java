...
import org.openimaj.data.dataset.AggregateGroupedDataset;
import org.openimaj.data.dataset.AggregateListDataset;
import org.openimaj.data.dataset.GroupedDataset;
import org.openimaj.data.dataset.ListDataset;
import org.openimaj.data.dataset.VFSMBFImageDatasetBuilder;
...
public abstract class DatasetBuilderUtilities {
	...
	public static GroupedDataset<String, ListDataset<MBFImage>, MBFImage> buildMBFImageDataset(String sourceString, int maxSize) throws IOException, InvalidDatasetException, BuildException {
		...
		AggregateGroupedDataset<String, ListDataset<MBFImage>, MBFImage, AggregateListDataset<MBFImage>> dataset =
			new AggregateGroupedDataset<String, ListDataset<MBFImage>, MBFImage, AggregateListDataset<MBFImage>>(
					(Class<AggregateListDataset<MBFImage>>) new AggregateListDataset<MBFImage>().getClass());
