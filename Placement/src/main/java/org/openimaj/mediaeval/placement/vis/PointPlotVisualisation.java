 ...
 */
public class PointPlotVisualisation extends XYPlotVisualisation<ColouredPoint> implements
		ItemPlotter<ColouredPoint, Float[], MBFImage> {
	...
	public void plotObject(MBFImage visImage,
			org.openimaj.vis.general.XYPlotVisualisation.LocatedObject<ColouredPoint> object,
