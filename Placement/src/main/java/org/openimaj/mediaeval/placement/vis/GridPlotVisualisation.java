 ...
 */
public class GridPlotVisualisation extends XYPlotVisualisation<ColouredSquare> implements ItemPlotter<ColouredSquare, Float[], MBFImage> {
     ...
     */
    @Override
    public void plotObject( MBFImage visImage, org.openimaj.vis.general.XYPlotVisualisation.LocatedObject<ColouredSquare> object, AxesRenderer2D<Float[], MBFImage> renderer ) {
