...
public class LireFeatureExtractor {
    ...
    public static void main( String args[] ) throws Exception {
        ...
        final DataOutputStream acc_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "acc.bin" ) ) ) );
        final DataOutputStream bf_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "bf.bin" ) ) ) );
        final DataOutputStream cedd_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "cedd.bin" ) ) ) );
        final DataOutputStream col_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "col.bin" ) ) ) );
        final DataOutputStream edgehistogram_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "edgehistogram.bin" ) ) ) );
        final DataOutputStream fcth_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "fcth.bin" ) ) ) );
        final DataOutputStream ophist_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "ophist.bin" ) ) ) );
        final DataOutputStream gabor_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "gabor.bin" ) ) ) );
        final DataOutputStream jhist_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "jhist.bin" ) ) ) );
        final DataOutputStream jophist_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "jophist.bin" ) ) ) );
        final DataOutputStream scalablecolor_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "scalablecolor.bin" ) ) ) );
        final DataOutputStream rgb_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "rgb.bin" ) ) ) );
        final DataOutputStream tamura_dos = new DataOutputStream( new BufferedOutputStream( new FileOutputStream( new File( OUTPUT_DIR + "tamura.bin" ) ) ) );
        ...
        final String firstLine = new TextLineIterable( new TextLineIterable.GZIPFileProvider( INPUT_FILES[0] ) ).iterator().next();
